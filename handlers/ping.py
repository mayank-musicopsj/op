...
from config import BOT_USERNAME, SUPPORT_GROUP, PING_IMG, BOT_NAME, OWNER_USERNAME
...
@Client.on_message(command(["ping", "repo", "anon", "alive"]) & filters.group & ~filters.private)
